#!/bin/bash
source functions_BSS_prod_con.sh
...
fork_list="16"  # or "1 2 3 4 5".  Forking number nfork later read from list and looped over
...
override_tempfile=1
#temp_list="0.874 0.875 0.876 0.877 0.878 0.879 0.88 0.881 0.882 0.883"
temp_list="0.2"
...
myersfix="0.0"          # value for fixing the myers term
g_myers=0            # supression level of fluctuations
myers_fix_width="0.04"   # width of unconstraint fluctuations
polfix="0.36"              # same for the Polyakov loop fixing
g_pol=4000              # g_pol
pol_fix_width="0.04"      # pol_fix_width
...
max_iteration=30000    # maximum number of CG-iteration
...
run_type_bfss="BFSS_prod"
therm_dir_bmn="therm_broad_output"
therm_dir_bfss="BFSS_therm_output"
